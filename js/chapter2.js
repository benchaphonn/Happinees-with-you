const cards = [
    ...
    { id:4, img:"assets/cards/card04.png", title:"ใจตรงกัน 💞", desc:"คุณคิดถึงเขา เขาก็คิดถึงคุณ ต่างฝ่ายต่างคิดถึงกันอยู่เสมอ" },
    ...
    { id:7, img:"assets/cards/card07.png", title:"ไพ่ก้าวหน้า 💯", desc:"ความสัมพันธ์กำลังค่อยๆดีขึ้น แม้จะช้าแต่มั่นคง" },
    ...
    { id:11, img:"assets/cards/card11.png", title:"คนแอบหวง 🫂", desc:"มีคนหวงคุณอยู่ แม้เขาจะไม่ยอมรับก็ตามชอบปากกึกมากจริง ๆ ทั้งคู่เลยหล่ะ ยอมแล้ว" },
  ...
  function getAdvice(id){
    const advice = {
      ...
      4:"🎁 ภารกิจ : ถามกันอะยังน้าเป็นไงบ้างวันนี้",
      5:"🎁 ภารกิจ : ยิ้มให้แฟนรักแฟนหลงสัก 3 ที",
      6:"🎁 ภารกิจ : ส่ง 💖 ให้แฟนสักดวง",
      ...
      10:"🎁 ภารกิจ : ถ่ายรูปรอยยิ้มกันไว้น้า ตอนยิ้มมันดีกว่าตอนไม่ยิ้มน้า",
      11:"🎁 ภารกิจ : ลองๆ ลงสตอรี่ดูหรือลงทวิตดูใครจะกดใจให้คนแรกน้า",
      12:"🎁 ภารกิจ : ลองส่งเพลงรักให้กันสัก 1 เพลง",
      13:"🎁 ภารกิจ : อะไรที่น่ารัก ๆ ส่งให้แฟนได้นะจะได้เติมหวาน อิอิ",
      14:"🎁 ภารกิจ : บอก 3 สิ่งที่ทำให้มีความสุข",
      15:"🎁 ภารกิจ : อาจจะต้องตอบแชทให้เร็วกว่าปกติอิอิ",
      16:"🎁 ภารกิจ : ถามตรง ๆ เลยน้าจะได้ไม่คาดเดาผิด ปุปุนะคับ",
      17:"🎁 ภารกิจ : ใครกันนะที่ชื่นชมหรือคนใกล้ตัวแกล้ง ๆ ถามก็ได้ คิคิ",
      ...
      21:"🎁 ภารกิจ : ส่งความรักให้ใครสักคนได้เลย",
      22:"🎁 ภารกิจ : เปิดเพลงที่สุ่มได้เพลงแรก แต่เพลงรักนะ55555",
      23:"🎁 ภารกิจ : อธิฐานความรัก 1 ข้อแต่เก็บไว้เป็นความลับนะ 🤔",
      24:"🎁 ภารกิจ : กินของหวานที่ชอบหรืออาจจะเป็นคนข้าง ๆ กันนะ",
      25:"🎁 ภารกิจ : คิดถึงแฟน 5 นาทีพอ หรือจะคิดถึงทั้งวันก็ได้เข้าใจอยู่",
      26:"🎁 ภารกิจ : ดวงมากี่ที่กี่หน สุดท้ายก็รักเธออยู่ดี"
    };
